...
export const CARD_DEFS: CardDef[] = [
  ...
  { id: 'camp_crimson_outpost', name: 'Ember Volley', icon: '🔥', type: 'damage', mode: 'coop', class: 'any', rarity: 'rare', desc: 'Deal 55 damage with a hail of crimson embers. Spoils of the Peasant\'s Outpost.', base: 55, mult: 1, campaignReward: true },
  { id: 'camp_crimson_camp', name: 'Phantom Blade', icon: '🗡️', type: 'damage', mode: 'coop', class: 'any', rarity: 'rare', desc: 'Deal 65 damage with a blade that strikes from smoke. Taken from the Goblin Camp.', base: 65, mult: 1, campaignReward: true },
  { id: 'camp_crimson_ambush', name: 'Time Fracture', icon: '⏳', type: 'spell', mode: 'coop', class: 'any', rarity: 'rare', desc: 'Enemies take 50% more damage from all sources for 2 turns. Forged in the Forest Ambush.', effect: 'enemy_curse', magnitude: 50, duration: 2, campaignReward: true },
  { id: 'camp_crimson_crossing', name: 'Resurrection Flame', icon: '✨', type: 'spell', mode: 'coop', class: 'any', rarity: 'rare', desc: 'Restore the party to 60% HP and clear all enemy shields. Gift of the Raider Crossing.', effect: 'heal', magnitude: 200, campaignReward: true },
  { id: 'camp_crimson_citadel', name: 'Crimson Apocalypse', icon: '🌋', type: 'damage', mode: 'coop', class: 'any', rarity: 'epic', desc: 'Deal 150 damage. The Crimson Citadel\'s banner, torn and burning.', base: 150, mult: 1, campaignReward: true },
  // Chapter II — The Frozen Throne (ice/frost theme)
  { id: 'camp_frost_pass', name: 'Blizzard Shard', icon: '🌨️', type: 'damage', mode: 'coop', class: 'any', rarity: 'rare', desc: 'Deal 50 damage and freeze the target for 1 turn. Carved from Frostfang Pass.', base: 50, mult: 1, campaignReward: true },
  { id: 'camp_frost_outpost', name: 'Frostbite Curse', icon: '🥶', type: 'spell', mode: 'coop', class: 'any', rarity: 'rare', desc: 'Enemies deal -30% damage for 3 turns. The cold of the Glacier Outpost lingers.', effect: 'enemy_curse', magnitude: 30, duration: 3, campaignReward: true },
  { id: 'camp_frost_cavern', name: 'Ice Lance', icon: '🔱', type: 'damage', mode: 'coop', class: 'any', rarity: 'rare', desc: 'Deal 120 damage to one enemy, ignoring shields. A shard from the Hollow Cavern.', base: 120, mult: 1, campaignReward: true },
  { id: 'camp_frost_approach', name: "Winter's Veil", icon: '🌫️', type: 'spell', mode: 'coop', class: 'any', rarity: 'rare', desc: 'Restore 70 party HP and shield against the next 2 turns of damage. Woven on the Throne Approach.', effect: 'party_shield_flat', magnitude: 80, duration: 2, campaignReward: true },
  { id: 'camp_frost_throne', name: 'Glacial Doom', icon: '🧊', type: 'damage', mode: 'coop', class: 'any', rarity: 'epic', desc: 'Deal 180 damage and freeze all enemies for 2 turns. The Frozen Throne, shattered.', base: 180, mult: 1, campaignReward: true },
  // Chapter III — The Verdant Maw (jungle/nature theme)
  { id: 'camp_maw_edge', name: 'Vine Grasp', icon: '🌿', type: 'damage', mode: 'coop', class: 'any', rarity: 'rare', desc: 'Deal 50 damage and freeze the target for 1 turn. Torn from the Thornwood Edge.', base: 50, mult: 1, campaignReward: true },
  { id: 'camp_maw_hollow', name: 'Spore Burst', icon: '🍄', type: 'spell', mode: 'coop', class: 'any', rarity: 'rare', desc: 'Enemies take 60 damage and -30% accuracy for 3 turns. A cloud from the Spore Hollow.', effect: 'enemy_miss', magnitude: 30, duration: 3, campaignReward: true },
  { id: 'camp_maw_garden', name: 'Thorn Lance', icon: '🌵', type: 'damage', mode: 'coop', class: 'any', rarity: 'rare', desc: 'Deal 160 damage to one enemy, ignoring shields. Grown in the Hanging Garden.', base: 160, mult: 1, campaignReward: true },
  { id: 'camp_maw_approach', name: 'Verdant Bloom', icon: '🌸', type: 'spell', mode: 'coop', class: 'any', rarity: 'rare', desc: 'Restore 100 party HP and grant +5 power for 3 turns. Blossomed at the Maw Approach.', effect: 'heal_over_time', magnitude: 100, duration: 3, campaignReward: true },
  { id: 'camp_maw_heart', name: 'Heart of the Maw', icon: '🫀', type: 'damage', mode: 'coop', class: 'any', rarity: 'epic', desc: 'Deal 220 damage. The Heart of the Maw, still beating in your hand.', base: 220, mult: 1, campaignReward: true },
];
