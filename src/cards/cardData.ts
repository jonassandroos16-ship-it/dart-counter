...
export const CARD_DEFS: CardDef[] = [
  ...
  { id: 'spell_double_up', name: 'Hexbolt', icon: '🌀', type: 'spell', mode: 'both', class: 'any', rarity: 'rare', desc: 'Curse all enemies: -25% damage for 2 turns.', effect: 'enemy_curse', magnitude: 25, duration: 2, levelRequired: 2 },
  ...
  { id: 'spell_rogue_trap', name: 'Snare Trap', icon: '🪤', type: 'spell', mode: 'both', class: 'rogue', rarity: 'rare', desc: 'Enemies have 30% chance to miss next turn.', effect: 'enemy_miss', magnitude: 30, duration: 1, levelRequired: 2 },
  ...
  { id: 'spell_warrior_bulwark', name: 'Bulwark', icon: '🛡️', type: 'spell', mode: 'both', class: 'warrior', rarity: 'epic', desc: 'Party gains a shield absorbing 150 flat damage for 3 turns.', effect: 'party_shield_flat', magnitude: 150, duration: 3, levelRequired: 5 },
  ...
  { id: 'spell_rogue_hemorrhage', name: 'Hemorrhage', icon: '🩸', type: 'spell', mode: 'both', class: 'rogue', rarity: 'epic', desc: 'Enemies bleed for 50 damage per turn for 4 turns.', effect: 'bleed', magnitude: 50, duration: 4, levelRequired: 5 },
  { id: 'spell_rogue_confusion', name: 'Confusion', icon: '🌀', type: 'spell', mode: 'both', class: 'rogue', rarity: 'epic', desc: 'Enemies have 50% chance to miss and deal -30% damage for 2 turns.', effect: 'enemy_miss', magnitude: 50, duration: 2, levelRequired: 5 },
  ...
  { id: 'util_pocket_sand', name: 'Pocket Sand', icon: '🏜️', type: 'utility', mode: 'both', class: 'any', rarity: 'rare', desc: 'Blind enemies: 25% miss chance for 2 turns.', effect: 'enemy_miss', magnitude: 25, duration: 2, levelRequired: 5 },
  ...
  { id: 'spell_priest_divine_favor', name: 'Divine Favor', icon: '🌟', type: 'spell', mode: 'both', class: 'priest', rarity: 'epic', desc: 'Party heals 40 HP per turn for 3 turns and draws 2 extra cards next turn.', effect: 'heal_over_time', magnitude: 40, extraDraws: 2, levelRequired: 6 },
  ...
  { id: 'spell_warrior_aegis', name: 'Aegis', icon: '🛡️', type: 'spell', mode: 'both', class: 'warrior', rarity: 'epic', desc: 'Party gains a shield absorbing 250 flat damage for 3 turns and +20% armor.', effect: 'party_shield_flat', magnitude: 250, duration: 3, levelRequired: 7 },
  { id: 'spell_priest_banish', name: 'Banish', icon: '🌑', type: 'spell', mode: 'both', class: 'priest', rarity: 'epic', desc: 'Banishes enemies: -60% damage, -30% armor, and 20% miss chance for 2 turns.', effect: 'enemy_curse', magnitude: 60, duration: 2, levelRequired: 7 },
  ...
  { id: 'spell_rogue_stun_trap', name: 'Stun Trap', icon: '⚡', type: 'spell', mode: 'both', class: 'rogue', rarity: 'epic', desc: 'Enemies are stunned: 60% chance to skip their next turn and 30% miss chance for 2 turns.', effect: 'enemy_miss', magnitude: 60, duration: 2, levelRequired: 7 },
  ...
  { id: 'spell_warrior_fortress', name: 'Fortress', icon: '🏰', type: 'spell', mode: 'both', class: 'warrior', rarity: 'epic', desc: 'Party gains +25% armor, a 300-damage shield, and +20 power for 3 turns.', effect: 'party_shield_flat', magnitude: 300, duration: 3, levelRequired: 8 },
  ...
  { id: 'spell_priest_feast', name: 'Divine Feast', icon: '🍷', type: 'spell', mode: 'both', class: 'priest', rarity: 'epic', desc: 'Party heals 100 HP per turn for 3 turns, gains +30% damage, and draws 3 extra cards.', effect: 'heal_over_time', magnitude: 100, extraDraws: 3, levelRequired: 8 },
  { id: 'spell_rogue_death_mark', name: 'Death Mark', icon: '💀', type: 'spell', mode: 'both', class: 'rogue', rarity: 'epic', desc: 'Marks all enemies: bleed 90 damage per turn for 4 turns and -50% healing.', effect: 'bleed', magnitude: 90, duration: 4, levelRequired: 8 },
  { id: 'spell_rogue_paranoia', name: 'Paranoia', icon: '😱', type: 'spell', mode: 'both', class: 'rogue', rarity: 'epic', desc: 'Enemies panic: 70% miss chance, -40% damage, and 40% chance to skip turns for 2 turns.', effect: 'enemy_miss', magnitude: 70, duration: 2, levelRequired: 8 },
  ...
  { id: 'spell_mirror_image', name: 'Mirror Image', icon: '🪞', type: 'spell', mode: 'both', class: 'any', rarity: 'epic', desc: 'Create illusions: 40% enemy miss chance and reflect 40% damage for 3 turns.', effect: 'reflect', magnitude: 40, duration: 3, levelRequired: 8 },
  ...
  { id: 'spell_warrior_last_stand', name: 'Last Stand', icon: '🛡️', type: 'spell', mode: 'both', class: 'warrior', rarity: 'epic', desc: 'Party gains a 500-damage shield, +30% armor, and +25 power for 3 turns.', effect: 'party_shield_flat', magnitude: 500, duration: 3, levelRequired: 9 },
  ...
  { id: 'spell_priest_ascension', name: 'Ascension', icon: '👼', type: 'spell', mode: 'both', class: 'priest', rarity: 'epic', desc: 'Party ascends: heals 120 HP/turn for 3 turns, +50% damage, and full card draw each turn.', effect: 'heal_over_time', magnitude: 120, extraDraws: 5, levelRequired: 9 },
  { id: 'spell_rogue_inferno_bleed', name: 'Inferno Bleed', icon: '🔥', type: 'spell', mode: 'both', class: 'rogue', rarity: 'epic', desc: 'Sets enemies ablaze: 120 bleed damage per turn for 4 turns and -60% healing.', effect: 'bleed', magnitude: 120, duration: 4, levelRequired: 9 },
  { id: 'spell_rogue_nightmare', name: 'Nightmare', icon: '😴', type: 'spell', mode: 'both', class: 'rogue', rarity: 'epic', desc: 'Enemies trapped in nightmares: 80% miss chance, 50% skip chance, -50% damage for 2 turns.', effect: 'enemy_miss', magnitude: 80, duration: 2, levelRequired: 9 },
  ...
  { id: 'spell_priest_holy_revelation', name: 'Holy Revelation', icon: '🌟', type: 'spell', mode: 'both', class: 'priest', rarity: 'epic', desc: 'Party heals 150 HP/turn for 3 turns, gains +75% damage, full revive, and 4 extra cards each turn.', effect: 'heal_over_time', magnitude: 150, extraDraws: 4, levelRequired: 10 },
  { id: 'spell_rogue_arterial_spray', name: 'Arterial Spray', icon: '🩸', type: 'spell', mode: 'both', class: 'rogue', rarity: 'epic', desc: 'Massive bleed: 150 damage per turn for 5 turns. -70% healing. Stacks with other bleeds.', effect: 'bleed', magnitude: 150, duration: 5, levelRequired: 10 },
  ...
  { id: 'spell_armageddon', name: 'Armageddon', icon: '☄️', type: 'spell', mode: 'both', class: 'any', rarity: 'epic', desc: 'Enemies take 100 damage/turn, -80% damage, 40% miss chance for 3 turns. Party heals 80 HP/turn.', effect: 'reflect', magnitude: 100, duration: 3, levelRequired: 10 },
  // ── Coop campaign mission reward cards ─────────────────────────────
  // Themed per chapter. Unlocked by clearing the matching mission, not by
  // class level. Available to any class so the whole party can wield them.
  // Once unlocked they are usable in both competitive and coop modes.
  // Chapter I — The Crimson Vale (fire/warlord theme)
  { id: 'camp_crimson_outpost', name: 'Ember Volley', icon: '🔥', type: 'damage', mode: 'both', class: 'any', rarity: 'rare', desc: 'Deal 55 damage with a hail of crimson embers. Spoils of the Peasant\'s Outpost.', base: 55, mult: 1, levelRequired: 1, campaignReward: true },
  { id: 'camp_crimson_camp', name: 'Phantom Blade', icon: '🗡️', type: 'damage', mode: 'both', class: 'any', rarity: 'rare', desc: 'Deal 65 damage with a blade that strikes from smoke. Taken from the Goblin Camp.', base: 65, mult: 1, levelRequired: 1, campaignReward: true },
  { id: 'camp_crimson_ambush', name: 'Time Fracture', icon: '⏳', type: 'spell', mode: 'both', class: 'any', rarity: 'rare', desc: 'Enemies take 50% more damage from all sources for 2 turns. Forged in the Forest Ambush.', effect: 'enemy_curse', magnitude: 50, duration: 2, levelRequired: 1, campaignReward: true },
  { id: 'camp_crimson_crossing', name: 'Resurrection Flame', icon: '✨', type: 'spell', mode: 'both', class: 'any', rarity: 'rare', desc: 'Restore the party to 60% HP and clear all enemy shields. Gift of the Raider Crossing.', effect: 'heal', magnitude: 200, levelRequired: 1, campaignReward: true },
  { id: 'camp_crimson_citadel', name: 'Crimson Apocalypse', icon: '🌋', type: 'damage', mode: 'both', class: 'any', rarity: 'epic', desc: 'Deal 150 damage. The Crimson Citadel\'s banner, torn and burning.', base: 150, mult: 1, levelRequired: 1, campaignReward: true },
  // Chapter II — The Frozen Throne (ice/frost theme)
  { id: 'camp_frost_pass', name: 'Blizzard Shard', icon: '🌨️', type: 'damage', mode: 'both', class: 'any', rarity: 'rare', desc: 'Deal 50 damage and freeze the target for 1 turn. Carved from Frostfang Pass.', base: 50, mult: 1, levelRequired: 1, campaignReward: true },
  { id: 'camp_frost_outpost', name: 'Frostbite Curse', icon: '🥶', type: 'spell', mode: 'both', class: 'any', rarity: 'rare', desc: 'Enemies deal -30% damage for 3 turns. The cold of the Glacier Outpost lingers.', effect: 'enemy_curse', magnitude: 30, duration: 3, levelRequired: 1, campaignReward: true },
  { id: 'camp_frost_cavern', name: 'Ice Lance', icon: '🔱', type: 'damage', mode: 'both', class: 'any', rarity: 'rare', desc: 'Deal 120 damage to one enemy, ignoring shields. A shard from the Hollow Cavern.', base: 120, mult: 1, levelRequired: 1, campaignReward: true },
  { id: 'camp_frost_approach', name: "Winter's Veil", icon: '🌫️', type: 'spell', mode: 'both', class: 'any', rarity: 'rare', desc: 'Restore 70 party HP and shield against the next 2 turns of damage. Woven on the Throne Approach.', effect: 'party_shield_flat', magnitude: 80, duration: 2, levelRequired: 1, campaignReward: true },
  { id: 'camp_frost_throne', name: 'Glacial Doom', icon: '🧊', type: 'damage', mode: 'both', class: 'any', rarity: 'epic', desc: 'Deal 180 damage and freeze all enemies for 2 turns. The Frozen Throne, shattered.', base: 180, mult: 1, levelRequired: 1, campaignReward: true },
  // Chapter III — The Verdant Maw (jungle/nature theme)
  { id: 'camp_maw_edge', name: 'Vine Grasp', icon: '🌿', type: 'damage', mode: 'both', class: 'any', rarity: 'rare', desc: 'Deal 50 damage and freeze the target for 1 turn. Torn from the Thornwood Edge.', base: 50, mult: 1, levelRequired: 1, campaignReward: true },
  { id: 'camp_maw_hollow', name: 'Spore Burst', icon: '🍄', type: 'spell', mode: 'both', class: 'any', rarity: 'rare', desc: 'Enemies take 60 damage and -30% accuracy for 3 turns. A cloud from the Spore Hollow.', effect: 'enemy_miss', magnitude: 30, duration: 3, levelRequired: 1, campaignReward: true },
  { id: 'camp_maw_garden', name: 'Thorn Lance', icon: '🌵', type: 'damage', mode: 'both', class: 'any', rarity: 'rare', desc: 'Deal 160 damage to one enemy, ignoring shields. Grown in the Hanging Garden.', base: 160, mult: 1, levelRequired: 1, campaignReward: true },
  { id: 'camp_maw_approach', name: 'Verdant Bloom', icon: '🌸', type: 'spell', mode: 'both', class: 'any', rarity: 'rare', desc: 'Restore 100 party HP and grant +5 power for 3 turns. Blossomed at the Maw Approach.', effect: 'heal_over_time', magnitude: 100, duration: 3, levelRequired: 1, campaignReward: true },
  { id: 'camp_maw_heart', name: 'Heart of the Maw', icon: '🫀', type: 'damage', mode: 'both', class: 'any', rarity: 'epic', desc: 'Deal 220 damage. The Heart of the Maw, still beating in your hand.', base: 220, mult: 1, levelRequired: 1, campaignReward: true },
];
