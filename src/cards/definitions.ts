...
export const CARD_DEFS: CardDef[] = [
  ...
  // Warrior: party shield (flat damage defense)
  ...
  { id: 'dmg_priest_smite_greater', name: 'Greater Smite', icon: '✨', type: 'damage', mode: 'both', class: 'priest', rarity: 'rare', desc: 'Deal 55 damage with divine power.', base: 50, mult: 1, levelRequired: 3 },
  ...
  // Priest: party fun (theme: divine fortune)
  ...
  // Priest: party heal + fun (theme: resurrection)
  ...
  // Priest: party heal + fun (theme: divine party)
  ...
  // Warrior: party buff (ultimate tankiness)
  ...
  // Priest: party heal + fun (theme: ascension)
  ...
  // Warrior: party buff (ultimate fortress)
  ...
  // Priest: party heal + fun (theme: divine resurrection party)
