...
const EFFECT_META: Record<string, EffectMeta> = {
  ...
  bust_protect:   { icon: '🛡️', label: 'Soul Barrier',   shortDesc: 'Prevents one bust this turn',         color: '#3b82f6' },
  double_up:      { icon: '🌀', label: 'Disrupt',        shortDesc: 'Disrupts enemy strike',               color: '#a78bfa' },
