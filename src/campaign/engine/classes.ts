...
//
// Tier unlock levels: 1, 2, 4, 6, 8 — spread across the full level range
// so players always have something to look forward to.
...
export const COOP_PASSIVES: CoopPassiveDef[] = [
  ...
  // Warrior — tier 3
  { id: 'war_power_3', classId: 'warrior', tier: 3, name: 'Berserker Aura', icon: '🔥', desc: 'Party +15 power (flat per dart).', bonus: { power: 15 }, levelRequired: 4 },
  { id: 'war_crit_3', classId: 'warrior', tier: 3, name: 'Executioner', icon: '🪓', desc: 'Party +12 power and +4 armor (flat).', bonus: { power: 12, armor: 4 }, levelRequired: 4 },
  { id: 'war_fury_3', classId: 'warrior', tier: 3, name: 'Unbreakable', icon: '🛡️', desc: 'Party +12 power and +180 max HP.', bonus: { power: 12, health: 180 }, levelRequired: 4 },
  // Warrior — tier 4
  { id: 'war_power_4', classId: 'warrior', tier: 4, name: 'Warlord\'s Roar', icon: '🐉', desc: 'Party +22 power (flat per dart).', bonus: { power: 22 }, levelRequired: 6 },
  { id: 'war_crit_4', classId: 'warrior', tier: 4, name: 'Crimson Reaper', icon: '🩸', desc: 'Party +18 power and +6 armor (flat).', bonus: { power: 18, armor: 6 }, levelRequired: 6 },
  { id: 'war_fury_4', classId: 'warrior', tier: 4, name: 'Iron Tide', icon: '🌊', desc: 'Party +18 power and +260 max HP.', bonus: { power: 18, health: 260 }, levelRequired: 6 },
  // Warrior — tier 5
  { id: 'war_power_5', classId: 'warrior', tier: 5, name: 'Apex Predator', icon: '🦖', desc: 'Party +32 power (flat per dart).', bonus: { power: 32 }, levelRequired: 8 },
  { id: 'war_crit_5', classId: 'warrior', tier: 5, name: 'Doombringer', icon: '☠️', desc: 'Party +26 power and +9 armor (flat).', bonus: { power: 26, armor: 9 }, levelRequired: 8 },
  { id: 'war_fury_5', classId: 'warrior', tier: 5, name: 'Titan\'s Vigor', icon: '🗿', desc: 'Party +26 power and +380 max HP.', bonus: { power: 26, health: 380 }, levelRequired: 8 },
  ...
  // Priest — tier 3
  { id: 'pri_hp_3', classId: 'priest', tier: 3, name: 'Divine Aegis', icon: '😇', desc: 'Party +300 max HP.', bonus: { health: 300 }, levelRequired: 4 },
  { id: 'pri_regen_3', classId: 'priest', tier: 3, name: 'Eternal Spring', icon: '⛲', desc: 'Party +240 max HP and +6 armor (flat).', bonus: { health: 240, armor: 6 }, levelRequired: 4 },
  { id: 'pri_shield_3', classId: 'priest', tier: 3, name: 'Celestial Bulwark', icon: '🌟', desc: 'Party +240 max HP and +10 power (flat).', bonus: { health: 240, power: 10 }, levelRequired: 4 },
  // Priest — tier 4
  { id: 'pri_hp_4', classId: 'priest', tier: 4, name: 'Heaven\'s Embrace', icon: '🙏', desc: 'Party +440 max HP.', bonus: { health: 440 }, levelRequired: 6 },
  { id: 'pri_regen_4', classId: 'priest', tier: 4, name: 'Lifewell Spring', icon: '💧', desc: 'Party +340 max HP and +9 armor (flat).', bonus: { health: 340, armor: 9 }, levelRequired: 6 },
  { id: 'pri_shield_4', classId: 'priest', tier: 4, name: 'Seraphic Aegis', icon: '🛡️', desc: 'Party +340 max HP and +15 power (flat).', bonus: { health: 340, power: 15 }, levelRequired: 6 },
  // Priest — tier 5
  { id: 'pri_hp_5', classId: 'priest', tier: 5, name: 'Eternal Covenant', icon: '✨', desc: 'Party +640 max HP.', bonus: { health: 640 }, levelRequired: 8 },
  { id: 'pri_regen_5', classId: 'priest', tier: 5, name: 'Font of Life', icon: '⛲', desc: 'Party +500 max HP and +13 armor (flat).', bonus: { health: 500, armor: 13 }, levelRequired: 8 },
  { id: 'pri_shield_5', classId: 'priest', tier: 5, name: 'Radiant Bastion', icon: '🌟', desc: 'Party +500 max HP and +22 power (flat).', bonus: { health: 500, power: 22 }, levelRequired: 8 },
  ...
  // Rogue — tier 3
  { id: 'rog_armor_3', classId: 'rogue', tier: 3, name: 'Phantom Guard', icon: '👻', desc: 'Party +10 armor (flat per enemy dart).', bonus: { armor: 10 }, levelRequired: 4 },
  { id: 'rog_dodge_3', classId: 'rogue', tier: 3, name: 'Afterimage', icon: '🌀', desc: 'Party +7 armor and +180 max HP.', bonus: { armor: 7, health: 180 }, levelRequired: 4 },
  { id: 'rog_thorns_3', classId: 'rogue', tier: 3, name: 'Spike Mail', icon: '🦔', desc: 'Party +7 armor and +12 power (flat).', bonus: { armor: 7, power: 12 }, levelRequired: 4 },
  // Rogue — tier 4
  { id: 'rog_armor_4', classId: 'rogue', tier: 4, name: 'Umbral Bulwark', icon: '🌑', desc: 'Party +15 armor (flat per enemy dart).', bonus: { armor: 15 }, levelRequired: 6 },
  { id: 'rog_dodge_4', classId: 'rogue', tier: 4, name: 'Mirror Step', icon: '🪞', desc: 'Party +11 armor and +260 max HP.', bonus: { armor: 11, health: 260 }, levelRequired: 6 },
  { id: 'rog_thorns_4', classId: 'rogue', tier: 4, name: 'Razor Barb', icon: '🔪', desc: 'Party +11 armor and +18 power (flat).', bonus: { armor: 11, power: 18 }, levelRequired: 6 },
  // Rogue — tier 5
  { id: 'rog_armor_5', classId: 'rogue', tier: 5, name: 'Eclipse Aegis', icon: '🌑', desc: 'Party +22 armor (flat per enemy dart).', bonus: { armor: 22 }, levelRequired: 8 },
  { id: 'rog_dodge_5', classId: 'rogue', tier: 5, name: 'Phantasm', icon: '🌫️', desc: 'Party +16 armor and +380 max HP.', bonus: { armor: 16, health: 380 }, levelRequired: 8 },
  { id: 'rog_thorns_5', classId: 'rogue', tier: 5, name: 'Maw of Thorns', icon: '🐉', desc: 'Party +16 armor and +26 power (flat).', bonus: { armor: 16, power: 26 }, levelRequired: 8 },
];
