  ...
  levels: [
    {
      ...
      reward_card: 'camp_crimson_outpost',
    ...
    },
    {
      ...
      reward_card: 'camp_crimson_ambush',
    ...
    },
    {
      ...
      reward_card: 'camp_crimson_crossing',
    ...
    },
    {
      ...
      reward_card: 'camp_crimson_citadel',
...
const CHAPTER_2: CampaignChapter = {
  ...
  levels: [
    { level_id: 1, name: 'Frostfang Pass', is_boss: false, enemies: ['ice_wolf', 'ice_wolf'], reward_power_up: 'coop_blizzard', reward_card: 'camp_frost_pass', story_bit: 'The wolves scatter into the snow. The pass is open — for now.' },
    { level_id: 2, name: 'Glacier Outpost', is_boss: false, enemies: ['frost_archer', 'ice_wolf'], reward_power_up: 'coop_frostbite', reward_card: 'camp_frost_outpost', story_bit: "The outpost's fires are out. We press on before the cold finds us again." },
    { level_id: 3, name: 'The Hollow Cavern', is_boss: false, enemies: ['frost_archer', 'frost_archer', 'ice_wolf'], reward_power_up: 'coop_ice_lance', reward_card: 'camp_frost_cavern', story_bit: "The cavern's echoes fade. Whatever lived down here lives here no longer." },
    { level_id: 4, name: 'Throne Approach', is_boss: false, enemies: ['frost_knight', 'frost_archer'], reward_power_up: 'coop_winter_veil', reward_card: 'camp_frost_approach', story_bit: 'The throne room is close. The air is too still to be empty.' },
    { level_id: 5, name: 'The Frozen Throne', is_boss: true, enemies: ['frost_knight', 'ice_queen'], reward_power_up: 'coop_glacial_doom', reward_card: 'camp_frost_throne', story_bit: 'The throne splits. The long winter ends, and the south begins to thaw.' },
  ],
};
...
const CHAPTER_3: CampaignChapter = {
  ...
  levels: [
    { level_id: 1, name: 'Thornwood Edge', is_boss: false, enemies: ['vine_lasher', 'vine_lasher'], reward_power_up: 'coop_vine_grasp', reward_card: 'camp_maw_edge', story_bit: 'The vines go slack at the treeline. The Maw has noticed us — and we have noticed it back.' },
    { level_id: 2, name: 'Spore Hollow', is_boss: false, enemies: ['spore_bloom', 'vine_lasher'], reward_power_up: 'coop_spore_burst', reward_card: 'camp_maw_hollow', story_bit: 'The hollow is still. The air is thick with something sweet and bad.' },
    { level_id: 3, name: 'The Hanging Garden', is_boss: false, enemies: ['spore_bloom', 'thorn_spearman', 'vine_lasher'], reward_power_up: 'coop_thorn_lance', reward_card: 'camp_maw_garden', story_bit: 'The garden falls. Whatever it was grown to feed is close now.' },
    { level_id: 4, name: 'Maw Approach', is_boss: false, enemies: ['thorn_spearman', 'bloom_warden'], reward_power_up: 'coop_verdant_bloom', reward_card: 'camp_maw_approach', story_bit: 'The canopy parts. The Maw is open ahead, and it is breathing.' },
    { level_id: 5, name: 'The Heart of the Maw', is_boss: true, enemies: ['bloom_warden', 'the_verdant_maw'], reward_power_up: 'coop_heart_of_maw', reward_card: 'camp_maw_heart', story_bit: 'The Heart splits like rotten fruit. The long green grip on the south is broken at last.' },
  ],
};
